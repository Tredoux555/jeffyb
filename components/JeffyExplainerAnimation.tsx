...
const slides: Slide[] = [
  {
    id: 1,
    title: "Hi! I'm Jeffy!",
    subtitle: "I only stock what YOU actually want!",
    dialogue: "Hi! I'm Jeffy! I don't guess what to sell... I ask YOU!",
    speaker: 'jeffy',
  ...
  },
  {
    id: 2,
    title: "The Problem",
    subtitle: "You can't find what you want at a fair price",
    dialogue: "I just want something that WORKS... without paying crazy prices.",
    speaker: 'thabo',
  ...
  },
  {
    ...
    subtitle: "And I'll find it for you!",
    dialogue: "Tell me exactly what you're looking for. I'll source it!",
    speaker: 'jeffy',
  ...
  },
  {
    ...
    subtitle: "10 people agree = I'll stock it!",
    dialogue: "Share your link. If 10 people say 'good idea'... I'll get it!",
    speaker: 'jeffy',
  ...
  },
  {
    id: 5,
    title: "50% OFF!",
    subtitle: "At cost price - my thanks to you!",
    dialogue: "For helping me know what to stock... YOU get it at HALF PRICE!",
    speaker: 'jeffy',
  ...
  },
  {
    ...
    subtitle: "Tell me below! ⬇️",
    dialogue: "So... what have you been looking for? Tell me!",
    speaker: 'jeffy',
    bgColor: 'from-yellow-400 to-amber-500',
    duration: 4000,
  },
